        ...
        <div>
            <div className='hero bg-[#9538E2] h-auto pt-5 pb-32 mt-5'>
                <div className='text-center'>
                    <h2 className='text-5xl font-bold text-white'>Product Details</h2>
                    <p className='py-6 max-w-md lg:max-w-2xl mx-auto text-gray-100'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae nesciunt incidunt iusto, accusantium aliquam iste voluptatem quisquam fugit repellendus ab.</p>
                </div>
            </div>
            <div className='border rounded-3xl relative bottom-36 p-4 w-10/12 lg:w-6/12 mx-auto bg-white'>
                <div className='flex items-center'>
                    <div>
                        <img className='w-[480px]' src={product_image} alt="" />
                    </div>
                    <div>
                        <h2 className='text-3xl font-bold'>{product_title}</h2>
                        <p className='text-lg font-semibold'>Price: {price}</p>
                        <p className='rounded-2xl w-24 text-center py-0.5 bg-lime-50 border border-[#23BE0A] text-[#23BE0A]'>{availability}</p>
                        <p>{description}</p>
                        <div>
